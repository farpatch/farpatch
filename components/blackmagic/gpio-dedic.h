...
#define ALL_OUTPUT_MASK (SWCLK_DEDIC_MASK | JTAG_TDI_DEDIC_MASK)
#else /* CONFIG_TMS_SWDIO_DIR_GPIO != 0 */
#define ALL_OUTPUT_MASK (SWCLK_DEDIC_MASK | JTAG_TDI_DEDIC_MASK | SWDIO_TMS_DIR_DEDIC_MASK)
#endif
#else /* CONFIG_TCK_TDI_DIR_GPIO != 0 */
#define ALL_OUTPUT_MASK (SWCLK_DEDIC_MASK | JTAG_TDI_DEDIC_MASK | SWDIO_TMS_DIR_DEDIC_MASK | SWCLK_DIR_DEDIC_MASK)
#endif
