...
#define CONFIG_ADC_VREF_CHANNEL   ADC_CHANNEL_3
...
#define CONFIG_ADC_VREF_CHANNEL   ADC_CHANNEL_8
#define CONFIG_RESET_PUSHPULL     1
...
#define CONFIG_UART_RX_GPIO       10
#define CONFIG_ADC_VREF_CHANNEL   ADC_CHANNEL_7

#define CONFIG_RESET_OPENDRAIN
...
#define CONFIG_TCK_SWCLK_GPIO     8
#define CONFIG_TCK_TDI_DIR_GPIO   15
...
#elif defined(CONFIG_FARPATCH_DVT7)
#define CONFIG_TDI_GPIO           11
#define CONFIG_TDO_GPIO           18
#define CONFIG_TMS_SWDIO_GPIO     21
#define CONFIG_TMS_SWDIO_DIR_GPIO 20
...
#define CONFIG_LED_GPIO           4
#define CONFIG_LED2_GPIO          5
#define CONFIG_LED3_GPIO          6
#define CONFIG_LED4_GPIO          7
#define CONFIG_UART_TX_DIR_GPIO   2
#define CONFIG_UART_TX_GPIO       17
#define CONFIG_UART_RX_GPIO       16
...
#if !defined(CONFIG_ADC_VREF_CHANNEL)
#define CONFIG_ADC_VREF_CHANNEL -1
#endif

#if !defined(CONFIG_ADC_SYSTEM_CHANNEL)
#define CONFIG_ADC_SYSTEM_CHANNEL -1
#endif

#if !defined(CONFIG_ADC_USB_CHANNEL)
#define CONFIG_ADC_USB_CHANNEL -1
#endif

#if !defined(CONFIG_ADC_EXT_CHANNEL)
#define CONFIG_ADC_EXT_CHANNEL -1
#endif

#if !defined(CONFIG_ADC_DEBUG_CHANNEL)
#define CONFIG_ADC_DEBUG_CHANNEL -1
#endif

#if !defined(CONFIG_ADC_UNIT)
